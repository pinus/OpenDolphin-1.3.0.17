 ...
 * @author pns
 */
public class JSheet2 extends JWindow implements ActionListener {
    ...
    private final Logger logger = LoggerFactory.getLogger(JSheet2.class);

    public JSheet2(Window owner) {
        super(owner);
        init(owner);
    }
    ...
    public static void showSheet(JOptionPane pane, Component parentComponent, SheetListener listener) {
        JSheet2 js = createDialog(pane, parentComponent);
    ...
    public static int showOptionDialog(Component parentComponent, Object message, String title,
        ...
        JSheet2.showSheet(pane, parentComponent, se -> answer[0] = se.getOption());
    ...
    public static boolean isAlreadyShown(Component parentComponent) {
        ...
        for (Window w : windowList) {
            if (w instanceof JSheet2 sheet && sheet.isVisible() && !sheet.isHiding()) {
                // すでに JSheet が表示されている
                return true;
            }
        }
    ...
    private class SheetKeyEventDispatcher implements KeyEventDispatcher {
        ...
        public boolean dispatchKeyEvent(KeyEvent e) {
            ...
            if (JSheet2.this.isActive() && animating && animationDirection == INCOMING) {
                stopAnimation();
                finishShowingSheet();
            }
            ...
            if (Objects.nonNull(optionPane)) {
                ...
                if (strokeForEvent.equals(escapeKey)) {
                    ...
                    InputMap map = JSheet2.this.getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW);
    ...
    public static void main(String[] arg) {
        ...
        JLabel label = new JLabel(new ImageIcon(JSheet2.class.getResource("/schemaeditor/usagi.jpg")));
        ...
        b1.addActionListener(e -> {
            ...
            JSheet2 sheet = JSheet2.createDialog(optionPane, frame);
        ...
        b2.addActionListener(e -> {
            ...
            JSheet2.showSheet(optionPane, frame, se -> System.out.println("option = " + se.getOption()));
        ...
        b3.addActionListener(e -> {
            ...
            JSheet2.showSaveSheet(chooser, frame, se -> {
                System.out.println("option = " + se.getOption());
        ...
        b4.addActionListener(e -> {
            JFileChooser chooser = new JFileChooser();
            JSheet2.showOpenSheet(chooser, frame, se -> {
                System.out.println("option = " + se.getOption());
                System.out.println("selected file = " + chooser.getSelectedFile());
            });
