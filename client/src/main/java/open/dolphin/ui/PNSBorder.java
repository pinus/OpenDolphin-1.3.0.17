...
public class PNSBorder {
    ...
    public static void drawAngle(int level, Color color, Graphics g, int x, int y, int width, int height) {
        int x1 = x + level;
        int x2 = width - 1 - level;
        int y1 = y + level;
        int y2 = height - 1 - level;
        g.setColor(color);
    ...
    public static void drawSelectedLine(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        g.drawLine(x, level, width, level);
        g.setColor(INSIDE_MIDDLE_COLOR);
        g.drawLine(x, level - 1, width, level - 1);
        g.setColor(MIDDLE_COLOR);
        g.drawLine(x, level - 2, width, level - 2);
    }
    ...
    public static void drawSelectedBlueLine(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        g.setColor(INSIDE_BLUE_COLOR);
        g.drawLine(x, level, width, level);
        g.setColor(INSIDE_MIDDLE_BLUE_COLOR);
        g.drawLine(x, level - 1, width, level - 1);
        g.setColor(MIDDLE_BLUE_COLOR);
        g.drawLine(x, level - 2, width, level - 2);
    }
    ...
    public static void drawSelectedGrayLine(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        g.setColor(INSIDE_GRAY_COLOR);
        g.drawLine(x, level, width, level);
        g.setColor(INSIDE_MIDDLE_GRAY_COLOR);
        g.drawLine(x, level - 1, width, level - 1);
        g.setColor(MIDDLE_GRAY_COLOR);
        g.drawLine(x, level - 2, width, level - 2);
    }
}
