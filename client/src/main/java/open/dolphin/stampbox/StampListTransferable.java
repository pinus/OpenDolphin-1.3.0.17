...
public final class StampListTransferable implements Transferable, ClipboardOwner {
    ...
    public static DataFlavor stampListFlavor = new DataFlavor(open.dolphin.stampbox.StampList.class, "Stamp List");

    public static final DataFlavor[] flavors = { StampListTransferable.stampListFlavor };

    private final StampList list;
	...
	return flavor.equals(stampListFlavor);
    }
