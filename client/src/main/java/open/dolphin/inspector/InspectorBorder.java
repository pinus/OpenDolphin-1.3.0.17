...
public class InspectorBorder extends AbstractBorder {
    ...
    private static final Insets BORDER_INSETS = new Insets(3,5,3,5);
    private static final Insets BORDER_INSETS_W_TITLE = new Insets(15,5,3,5);
    ...
    public void paintBorder(Component c, Graphics graphics, int x, int y, int width, int height) {
        ...
        if (title != null) {
            ...
            g.drawString(title, insets.left + spacing, g.getFontMetrics().getAscent());
        }
