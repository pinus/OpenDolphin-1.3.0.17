...
public class DailyDoseStringTool {
    ...
    /**
     * １日量文字列 src の dose 部分を dose で置き換える
     * @param src
     * @param dose
     * @return
     */
    public static String getString(String src, double dose) {
        ...
        s.append(src.substring(0, index[0]));
        s.append(num);
        s.append(src.substring(index[1]));
     ...
     * index[0] = startIndex,  index[1] = endIndex,  index[2] = unit start index
     * @param str
     * @return
     */
