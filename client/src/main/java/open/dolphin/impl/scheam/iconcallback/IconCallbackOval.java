 ...
 * @author pns
 */
public class IconCallbackOval implements PnsIconCallback<FillMode, Node> {
    private final Shape line, fill, mix, sline, sfill, smix;

    public IconCallbackOval() {
        double r = 6;
        line = ShapeIcon.getCircle(r, r, Const.PNS_BLACK, Color.TRANSPARENT);
        fill = ShapeIcon.getCircle(r, r, null, Const.PNS_GLAY);
        ...
        sfill = ShapeIcon.getCircle(r, r, null, Const.PNS_LIGHT_GLAY);
