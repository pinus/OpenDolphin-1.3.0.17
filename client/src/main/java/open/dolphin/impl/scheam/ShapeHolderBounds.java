...
public class ShapeHolderBounds {
    ...
    public DoubleProperty blurProperty() { return blur; }
    public ReadOnlyDoubleWrapper minXProperty() { return minx; }
    public ReadOnlyDoubleWrapper minYProperty() { return miny; }
    public ReadOnlyDoubleWrapper maxXProperty() { return maxx; }
    public ReadOnlyDoubleWrapper maxYProperty() { return maxy; }
    public ReadOnlyDoubleWrapper widthProperty() { return width; }
    public ReadOnlyDoubleWrapper heightProperty() { return height; }
    public ReadOnlyDoubleWrapper minSpanProperty() { return minSpan; }
    public ReadOnlyDoubleWrapper maxSpanProperty() { return maxSpan; }
    public ReadOnlyDoubleWrapper blurRadiusProperty() { return blurRadius; }
}
