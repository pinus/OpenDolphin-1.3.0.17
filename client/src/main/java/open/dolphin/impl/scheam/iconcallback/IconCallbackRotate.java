 ...
 * @author pns
 */
public class IconCallbackRotate implements PnsIconCallback<FillMode, Node>{
    private final Shape icon, selectedIcon;

    public IconCallbackRotate() {
        icon = ShapeIcon.getRotate();
        selectedIcon = ShapeIcon.getRotate();
