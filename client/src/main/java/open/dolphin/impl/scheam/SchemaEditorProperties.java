...
public class SchemaEditorProperties {
     ...
     * @return
     */
    public Property[] getPropertiesRelatedToColorModel() {
        return propertiesRelatedToColorModel;
    }
     ...
     * @return
     */
    public ObjectProperty<State> previewStateProperty() {
        return previewState;
    }

    public State getPreviewState() {
        return previewState.get();
    }

    public void setPreviewState(State s) {
        previewState.set(s);
    }
