...
public class UndoManager {
    ...
    private class ValueChangingListener implements ChangeListener<Boolean> {
        ...
        public ValueChangingListener(ShapeHolderBase h) { holder  = h; }
    ...
    private class LineWidthListener implements ChangeListener<Number> {
        ...
        public LineWidthListener(ShapeHolderBase h) { holder  = h; }
    ...
    public IntegerProperty undoQueueSizeProperty() { return undoQueue.sizeProperty(); }
    public IntegerProperty redoQueueSizeProperty() { return redoQueue.sizeProperty(); }
    public void clearQueue() { undoQueue.clear(); redoQueue.clear(); }
}
