...
//pns   int width = this.getWidth();
//pns   int height = this.getHeight();
//pns   System.out.println("( " + width + " , " + height + " )");
    }
        ...
        for (int i = 0; i < itemCount; i++) {
            ...
            for (int j = 0; j < size; j++) {
                ...
                try {
                    ...
                    System.out.println("LaboTestGraph.java: " + e);
                    System.out.println("dummy value set");
                    data[i][j] = DUMMY_VALUE;
                } catch (Exception e) {
                    data[i][j] = DUMMY_VALUE;
                }
